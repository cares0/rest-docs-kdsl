package cares.restdocskdsl.example

import cares.restdocskdsl.dsl.*
import cares.restdocskdsl.example.controller.ExampleController
import cares.restdocskdsl.example.controller.dsl.FullUsageApiSpec
import cares.restdocskdsl.example.controller.dsl.SimpleUsageApiSpec
...
class ExampleControllerTest {
    ...
    fun simpleUsage() {
        mockMvc.post("/simple-usage") {
            requestAttr(RestDocumentationGenerator.ATTRIBUTE_NAME_URL_TEMPLATE, "/simple")
    ...
    fun fullUsage() {
        mockMvc.post("/full-usage/{exampleId}", "exampleId") {
            requestAttr(RestDocumentationGenerator.ATTRIBUTE_NAME_URL_TEMPLATE, "/examples/{exampleId}")
            contentType = MediaType.APPLICATION_JSON
            characterEncoding = StandardCharsets.UTF_8.name()
